       ...
       <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="../gudang/stok.php">
...
<?php endif; ?>
            ...
            <!-- <h2>Section title</h2> -->
            <a href="../gudang/barang_masuk.php" class="btn mr-1 btn-primary"> tambah stok</a>
              ...
              <table class=" table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="../gudang/barang_keluar.php?id=<?= $row['ID_gudang']; ?>"
                        class="btn btn-warning btn-sm">
                        barang Keluar
                      </a></td>
                    <td>
                      <a href="../php/gudang/delete.php?id=<?= $row['ID_gudang']; ?>"
            ...
            <div class=" container mt-4 ">
              ...
              <?php
                ...
                // Barang Keluar > 0
                $barangKeluar = mysqli_query($conn, "SELECT * FROM stok_gudang WHERE barang_keluar > 0");

                // Seluruh stok
                $stokGudang = mysqli_query($conn, "SELECT * FROM stok_gudang");
                ?>

              <h2>Barang Keluar</h2>
              <?php if (mysqli_num_rows($barangKeluar) > 0): ?>
              <table border="1" cellpadding="8" cellspacing="0">
                ...
                <?php while ($row = mysqli_fetch_assoc($barangKeluar)) : ?>
                <tr>
                  <!-- <td><?= $row['ID_gudang'] ?></td> -->
                  <td><?= $row['keterangan'] ?></td>
                  <td><?= $row['jenis_barang'] ?></td>
              ...
              <?php else: ?>
              <p style="color: red;">❗ Belum ada barang yang keluar</p>
              <?php endif; ?>
