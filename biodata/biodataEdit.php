      ...
      <div class="row justify-content-center g-4">
        ...
        <div class="col-12 col-md-4">
          <div class="card shadow-sm p-3">
            ...
            <input type="file" class="form-control" name="foto" id="foto" onchange="previewFoto()"
              <?= $foto ? '' : 'required' ?>>
          </div>
        </div>
        ...
        <div class="col-12 col-md-6">
          <div class="card shadow-sm p-4">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="hp" name="nomor_hp" placeholder="Nomor HP"
                value="<?= htmlspecialchars($nomor_hp ?? '') ?>" required>
            </div>

            <div class="mb-3">
              <label for="kodepos" class="form-label">Kode Pos</label>
              <input type="text" class="form-control" name="kode_pos" id="kodepos" placeholder="Kode Pos"
                value="<?= htmlspecialchars($kode_pos ?? '') ?>" required>
            </div>
